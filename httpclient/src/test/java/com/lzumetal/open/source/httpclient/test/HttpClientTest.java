package com.lzumetal.open.source.httpclient.test;

import com.lzumetal.open.source.httpclient.HttpclientBootstrap;
import com.lzumetal.open.source.httpclient.utils.HttpRequest;
...
@SpringBootTest(classes = {HttpclientBootstrap.class})
@Slf4j
